...
public interface PackageInfo extends NuxeoArtifact {
    ...
    String CONNECT_URL_PROP_NAME = "nuxeo.apidoc.connect.url";
    ...
    /**
     * Returns the list of bundles ids identified for this package.
     * <p>
     * Current matching on live runtime is based on the jar file name, as held by the bundle.
     */
